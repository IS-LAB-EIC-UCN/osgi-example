...
import cl.ucn.felix.biblioteca.api.ExepcionLibroInvalido;
import cl.ucn.felix.biblioteca.api.ExepcionLibroNoEncontrado;
...
public class InventarioImpl implements Inventario {
	...
	public LibroMutable cargarLibroParaEdicion(String isbn) throws ExepcionLibroNoEncontrado {

		LibroMutable libro= this.libroByIsbn.get(isbn);
		if (libro == null) {
			throw new ExepcionLibroNoEncontrado(isbn);
		}
		return libro;
	}
	...
	public String guardarLibro(LibroMutable libro) throws ExepcionLibroInvalido {


		String isbn = libro.getIsbn();
		if (isbn == null) {

			throw new ExepcionLibroInvalido("ISBN no esta seteado");
	...
	public void removerLibro(String isbn) throws ExepcionLibroNoEncontrado {
	...
	public Libro cargarLibro(String isbn) throws ExepcionLibroNoEncontrado {

		return cargarLibroEditar(isbn);

	}

	public LibroMutable cargarLibroEditar(String isbn) throws ExepcionLibroNoEncontrado
	{
		LibroMutable libro = this.libroByIsbn.get(isbn);
		if (libro == null) {
			throw new ExepcionLibroNoEncontrado(isbn);
